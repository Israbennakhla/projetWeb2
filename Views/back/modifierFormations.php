...
if (
    ...
    $formation = new Formation($id, $title, $description, $tuteur, $prix);
                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="container mt-5">
                        <form method="post" action="">
                            <input name="id" value="<?= $formation['id'] ?>" style="display: none;">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="title" name="title"
                                    value="<?= $formation['title'] ?>" required>
                            </div>
                            <div class="form-group">
                                <label for="description">Description</label>
                                <input type="text" class="form-control" id="description" name="description"
                                    value="<?= $formation['description'] ?>" required>
                            </div>
                            <div class="form-group">
                                <label for="tuteur">Tuteur</label>
                                <input type="text" class="form-control" id="tuteur" name="tuteur"
                                    value="<?= $formation['tuteur'] ?>" required>
                            </div>

                            <div class="form-group">
                                <label for="prix">Prix</label>
                                <input type="number" class="form-control" id="prix" name="prix"
                                    value="<?= $formation['prix'] ?>" required>
                            </div>



                            <button type="submit" class="btn btn-primary">Modifier</button>
                            <a href="formations.php" class="btn btn-danger">Retour à la liste</a>
                        </form>
                    </div>
                </div>
            </main>
